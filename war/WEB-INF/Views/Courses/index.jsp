	  ...
	  <div class="row content">
	    <div class="col-sm-2 sidenav">
	       <div class="navbar-nav mr-auto  text-left">
				    ...
				    <a class="nav-item nav-link" href="/courses/add">New Course</a>
			</div>
	    </div>
	    ...
	    <br>
		  ...
		  <table class="table table-bordered">
		    ...
		    <tbody>
              ...
              <% 
				List<Course> array = (List<Course>)request.getAttribute("courses");
		      ...
		      <tr>
		        ...
		        <td><%=course.getIdTeacher()%> / <%=course.getEmailTeacher()%></td>
		        <td><%=course.isStatus() %></td>
		        <td><%=course.getCreated() %></td>
		        <td>
		        <a href="/courses/view?id=<%=course.getId()%>">View</a>  
		        <a href="/courses/edit?id=<%=course.getId()%>">Edit</a>  
		        <a href="/courses/delete?id=<%=course.getId()%>">Delete</a>
		        </td>
		      </tr>
		      	<% } } %>
		    </tbody>
