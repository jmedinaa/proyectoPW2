	  ...
	  <div class="row content">
	    <div class="col-sm-2 sidenav">
	       <div class="navbar-nav mr-auto  text-left">
				    ...
				    <a class="nav-item nav-link" href="/reports/add">New Report</a>
			</div>
	    </div>
	    ...
	    <br>
		  ...
		  <table class="table table-bordered">
		    ...
		    <tbody>
              ...
              <% 
				List<Report> array = (List<Report>)request.getAttribute("reports");
		      ...
		      <tr>
		        ...
		        <td><%=report.getNameSender() %></td>
		        <td><%=report.getCreated() %></td>
		        <td>
		        <a href="/reports/view?id=<%=report.getId()%>">View</a>  
		        <a href="/reports/edit?id=<%=report.getId()%>">Edit</a>  
		        <a href="/reports/delete?id=<%=report.getId()%>">Delete</a>
		        </td>
		      </tr>
		      	<% } } %>
		    </tbody>
