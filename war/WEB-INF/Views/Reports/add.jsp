...
<body>
	...
	<div class="container-fluid text-center">    
	  <div class="row content">
	    ...
	    <br>
	      <h3 class="text-primary">New Report</h3>
		  <form method="post"  action="/reports/add">
		   <div class="form-group">
			    <label>Issue:</label>
			    <input type="text" name="issue" class="form-control" placeholder="issue"  maxlength="20" required autofocus>
		   </div>
		   <div class="form-group">
			    <label>Name Sender:</label>
			    <input type="text" name="nameSender" class="form-control" placeholder="Name Sender"  maxlength="20" required autofocus>
		   </div>
		   <div class="form-group">
