...
public class NotesControllerView extends HttpServlet{
	...
	if(currentUser==null){
		...
		if(currentUser.getEmail().equals("jmedinaa@unsa.edu.pe")){
			...
			Key k = KeyFactory.createKey(Note.class.getSimpleName(), new Long(req.getParameter("id")).longValue());
			Note note = pm.getObjectById(Note.class, k);
			req.setAttribute("note", note);
			RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/Views/Notes/view.jsp");
